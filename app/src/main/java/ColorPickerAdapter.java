...
public class ColorPickerAdapter extends RecyclerView.Adapter<ColorPickerAdapter.ViewHolder> {
    ...
    public static List<Integer> getDefaultColors(Context context) {
        ...
        colorPickerColors.add(ContextCompat.getColor(context, R.color.dark_green_color_picker));
        colorPickerColors.add(ContextCompat.getColor(context, R.color.dark_blue_color));
        colorPickerColors.add(ContextCompat.getColor(context, R.color.dark_grey_color_picker));
